...
if a==0:
    ...
    def getdata():
        ...
        create_table=f"create table '{sttnm}' ('{stcl1}' integer primary key autoincrement, '{stcl2}' text,'{stcl3}' text)"
        try:
             dbcon.execute(create_table)
             print("Table created successfuly")
        except Exception as e:
             print(e)
    n=int(input("how many create table"))
    for i in range(n):
        getdata()
     ...
     def getdata1():
         ...
         insert_data=f"insert into '{sttnm}'(name,city) values('{stnm}','{stcy}')"
         try:
    ...
    def getdata2():
        ...
        try:
         ...
         print(e)
    n=int(input("how many update data"))
    for i in range(n):
        getdata2()
